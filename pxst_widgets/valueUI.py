...
from PyQt5.QtWidgets import QWidget, QPushButton, QVBoxLayout, QGroupBox, QHBoxLayout, QSlider, QLabel, QLineEdit, QCheckBox, QAbstractSlider
...
class StringUI(AbstractValueUI):
    """
